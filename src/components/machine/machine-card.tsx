...
export function MachineCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-3 text-2xl font-bold text-zinc-950">{name}</h3>
      <p className="mt-2 font-semibold text-zinc-700">{highlight}</p>

      <ul className="mt-6 grid gap-3 text-sm text-zinc-600">
